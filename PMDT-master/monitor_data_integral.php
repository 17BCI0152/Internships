                        ...
                        <div class="inner" style="margin-left: 3%;">
                            ...
                            <div id="Div1" style="height:545px !important;">
                                ...
                                <table class="ex1" border="1">
                                    <?php
                                        include('config.php');
                                        $sql="SELECT * from monitord WHERE main='Integral' AND  type='Course'";
                                ...
                                <table class="ex1" border="1">
                                    ...
                                    <?php
                                        include('config.php');
                                        $sql="SELECT m1,m2 from monitord WHERE main='Integral' AND  type='clearance'";
                                        $result=$conn->query($sql);
                                        if($result->num_rows>0)
                                        {
                                            $a=[];
                                ...
                                <table class="ex1" border="1">
                                    <?php
                                        include('config.php');
                                        $sql="SELECT m1,m2 from monitord WHERE main='Integral' AND  type=''";
                                        $result=$conn->query($sql);
                                        if($result->num_rows>0)
                                        {
                                            $a=[];
