...
<body>
    ...
    function tx2($data,$i){
        include("config.php");
        $sql1="INSERT INTO tx(name,main,antenna,off) VALUES ('tx2','G','G','R')";
        if ($conn->query($sql1) == True) {
            echo "<br>Successfully Uploaded!!!<br>";
        }
    }
	...
	<div class="content">
        ...
        <div>
            <br>If u want to see the existing data? <a href="../system.php">Click Here</a>
        ...
        if(isset($_POST["submit"]))
        {
            ...
            while($i<sizeof($data)){
                ...
                if(strpos(strtolower($data[$i]),"tx1 data")!==false)
                    tx1($data,$i);
                if(strpos(strtolower($data[$i]),"tx2 data")!==false)
                    tx2($data,$i); 
                $i+=1;
    ...
    <br> <br>
    <p>
			If u want to add a user? <a href="create_user.php">Add User or Admin</a>
    </p>
    <br>
    <p>
